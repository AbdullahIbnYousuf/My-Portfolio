...
const Navbar = () => {
  ...
  return (
    <nav className="fixed w-full z-50 text bg-dark-100/90 backdrop-blur-sm py-4 px-8 shadow-lg">
      <div className="container mx-auto flex justify-between items-center">
        <div>
          <a href="#" className="text-3xl font-bold text-white">
            Abdullah
            <br className="md:hidden" /> {/* break only on small screens */}
            <span className="text-purple whitespace-nowrap">
              Ibn&nbsp;Yousuf
            </span>{" "}
            {/* prevents break between Ibn and Yousuf */}
